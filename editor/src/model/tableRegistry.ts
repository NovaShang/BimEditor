...
// Shared option lists moved to elements/_options.ts to keep them importable
// without depending on tableRegistry. Re-exported here so existing consumers
// continue working until they migrate to the direct import.
export {
  MATERIAL_OPTIONS,
  OPERATION_OPTIONS,
  HINGE_OPTIONS,
